...
public class KitLoadEvent extends CancellableKitEvent {
    private final SavedContents contents;
    private final int position;

    public KitLoadEvent(final @NotNull Player player, final @NotNull SavedContents contents, final int position) {
        super(player);
